...
const AddDestinationPage = () => {
    ...
    return (
        <div className='container mx-auto py-8 px-10'>
            <div>
                <h2 className='text-3xl md:text-4xl font-extrabold text-center'>Add New Travel Package</h2>
            </div>

            <form onSubmit={onSubmit} className="p-10 space-y-8 md:w-150 mx-auto border border-gray-300 my-6 shadow">
